...
public interface CertifiedPracticeLogRepository
    ...
    List<CertifiedPracticeLog> findByFarmerId(Long farmerId);

    List<CertifiedPracticeLog> findByFarmerIdAndStatus(
            Long farmerId,
    ...
    List<CertifiedPracticeLog> findByFarmerIdAndCategoryAndStatus(
            Long farmerId,
